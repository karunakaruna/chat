 ...
 * @property {PolarPosition} position
 * @property {number} lastActive
 * @property {boolean} cohered
 */
...
export const lerpPolar = (start, end, t) => {
...
// Browser-compatible MD5 implementation
